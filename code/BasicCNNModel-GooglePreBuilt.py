...
if __name__ == '__main__':
    ...
    batchsize = 50 #Number of images to be used in each processing batch. Larger batches have a greater impact on training accuracy but that isn't always a good thing
    trainingsamples = 4000 #Number of images to be used for training set
    validationsamples = 2000 #Number of images to be used for validation set
...
#the following code reads images, trains the model, and saves the training history to a csv file:
    ...
    hist.to_csv('..\\results\\'+model_name+'.csv')
